...
class ModelLogger:
    ...
    def on_epoch_end(self, accelerator: Accelerator, model: DiffusionTrainingModule, epoch_id):
        ...
        for data in tqdm(dataloader):
            with accelerator.accumulate(model):
                ...
                if dataset.load_from_cache:
                    loss = model({}, inputs=data, epoch_progress=epoch_id / num_epochs)
                else:
                    loss = model(data, epoch_progress=epoch_id / num_epochs)
...
def wan_parser():
    ...
    parser.add_argument("--concept_adapter_load_path", type=str, default=None, help="Path to load the concept adapter checkpoint.")
    parser.add_argument("--concept_adapter_moe", default=False, action="store_true", help="Whether to use MoE for the concept adapter.")
    return parser
